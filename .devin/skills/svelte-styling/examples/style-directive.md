...
<div style:background-color={`hsl(${hue}, 80%, 60%)`} style:--progress="{progress}%">Preview</div>
...
<!-- this is fine, but -->
<div style:color-scheme>...</div>
<!-- the variable name "color-scheme" is fine, this is regular CSS property -->
```
