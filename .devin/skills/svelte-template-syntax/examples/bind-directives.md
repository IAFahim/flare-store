...
```svelte
<audio src={clip} bind:duration bind:currentTime bind:paused bind:volume bind:muted></audio>

<video src={clip} bind:currentTime bind:videoWidth bind:videoHeight></video>
```
